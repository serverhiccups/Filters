...
public class BasicFilter implements Filter {
	...
	/**
	 * This is a helper method for subclasses that returns a Color[][] array of the kernel around the position requested.
	 ...
	 * @return A Color[][] array of the pixels in the requested kernel.
	...
	public Color[][] getKernel(int imageNumber, int x, int y, int size) throws FilterException {
		Color[][] kernel = new Color[size][size]; // Create a new array for our kernel to go into.
